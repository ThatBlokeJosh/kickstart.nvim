...
syn keyword pythonStatement	fn nextgroup=pythonFunction skipwhite
syn keyword pythonConditional	else if else if
syn keyword pythonRepeat	for
...
if !exists("python_no_builtin_highlight")
  ...
  syn keyword pythonBuiltin	true false	
  " constants added by the `site` module
  " built-in functions
  syn keyword pythonBuiltin	print pow
